...
class Follower:
    def __init__(self,name):
        ...
        self.image_sub = rospy.Subscriber(f'/{self.which_robo}/camera/rgb/image_raw', Image, self.image_callback)
        self.cmd_vel_pub = rospy.Publisher(f'/{self.which_robo}/cmd_vel', Twist, queue_size=1)
        self.twist = Twist()
        self.logcount = 0
        self.lostcount = 0
    ...
    def image_callback(self, msg):
        ...
        lower_yellow = numpy.array([ 40, 0, 0]) # [ 40, 0, 0], ([5, 100, 100]) 
        upper_yellow = numpy.array([ 120, 255, 255]) # [ 120, 255, 255], [40, 255, 255]
