...
class Follower:
    def __init__(self,name):
        ...
        "rob_c": {"color": "blue", "low": numpy.array([110,50,50]),"high":numpy.array([130,255,255])}, "rob_b": {"color": "yellow", "low": numpy.array([5, 70, 70]), "high": numpy.array([75,220,220])}}
...
# This is the method that will be making the robot find the line that it is going to be following. 
    def image_callback(self, msg):
        ...
        if(self.lower==None and self.higher==None):
            lower_green = self.lower_green  # [ 40, 0, 0], ([5, 100, 100]) 
            upper_green = self.upper_green # [ 120, 255, 255], [40, 255, 255]
