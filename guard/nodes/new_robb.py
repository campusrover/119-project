...
class Follower:
    def __init__(self,name):
        ...
        self.lower_yellow=numpy.array([5, 110, 110])
        self.upper_yellow=numpy.array([45,220,220])
...
# This is the method that will be making the robot find the line that it is going to be following. 
    def see_intruder_callback(self, msg):
        ...
        print("This little robot see the intruder: "+self.which_robo_see)

    def stop_callback(self,msg):
        self.stop_order.order_list = msg.order_list
        print("This index: "+str(msg.idx.data))
        if msg.idx.data != -1:
...
# This is the method that will be making the robot find the line that it is going to be following. 
    def image_callback(self, msg):
        ...
        if(self.lower.all()==0):
            ...
            upper_yellow = self.upper_yellow# [ 120, 255, 255], [40, 255, 255]
    ...
    def change_state(self):
        ...
        if self.i_state == "finish_turn" and self.region[0]>d and len(self.stop_order.order_list)==2 and not self.ready:
            ...
            msg = see_intruder()
            msg.rob_b.data = True
            print("I publish the msg:"+str(msg))
