...
class Follower:
    def __init__(self,name):
        ...
        self.lower_red=numpy.array([90,120,120])
        self.upper_red=numpy.array([135,220,220])
        # Real robot uses '/raspicam_node/image/compressed'
        self.lower=numpy.array([90,120,120])
        self.higher=numpy.array([135,220,220])
        self.stop = False
