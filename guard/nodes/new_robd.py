...
class Follower:
    def __init__(self,name):
        ...
        self.lower_red=numpy.array([76, 110, 110])
        self.upper_red=numpy.array([94, 255, 200])
        # Real robot uses '/raspicam_node/image/compressed'
        self.lower=numpy.array([76, 110, 166])
        self.higher=numpy.array([84, 255, 200])
        self.stop = False
        ...
        if(self.dummy=="roba"):
            ...
            self.order=1
            self.static_order=self.order
        elif(self.dummy=="rafael"):
            self.order=3
            self.static_order=self.order
        self.which_robo_see = ""
        self.color_dict = {"rob_a": {"color": "red","low": numpy.array([155,25,0]), "high": numpy.array([245,222,222])}, "rob_d": {"color":"green", "low":numpy.array([76, 110, 110]), "high":numpy.array([94, 255, 200])},
...
# This is the method that will be making the robot find the line that it is going to be following. 
    ...
    def scan_cb(self, msg):
        ...
        front = ranges[0:16]+ranges[215:]
        front_left = ranges[17:40]
        left = ranges[41:75]
        back_left = ranges[76:110]
        back_right = ranges[111:144]
        right = ranges[145:181] 
        front_right = ranges[182:235]
